...
export const articles: Article[] = [
  ...
  },
  {
    ...
    excerpt: 'Dans un monde où le e-commerce domine, le magasin physique doit se réinventer. L',
    content: 'Le retail physique n',
    category: 'Tendances',
  ...
  },
  {
    ...
    content: 'La table tactile est devenue un outil incontournable dans les showrooms et les espaces de négociation. Mais comment choisir le bon modèle ?\n\n## Taille et résolution\n\nLa taille dépend de votre usage. Pour une négociation en face-à-face, un modèle 43 pouces suffit. Pour un showroom accueillant des groupes, visez 55 à 65 pouces. La résolution 4K est aujourd',
    category: 'Présentation Innovante',
    categorySlug: 'presentation-innovante',
    date: '5 Déc 2024',
    author: 'Thomas Bernard',
